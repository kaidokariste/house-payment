...
const (
	// openssl genrsa -out household.rsa 1024
	privKeyPath = "key/household.rsa"
	// openssl rsa -in household.rsa -pubout > household.rsa.pub
	pubKeyPath = "key/household.rsa.pub"
)
